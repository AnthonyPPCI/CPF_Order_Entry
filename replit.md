...
-   **Differential Markup**: Standalone components (acrylic, backing, mats) use 3.5× flat markup when ordered without a frame. Components ordered with frames use 3.0× flat markup, incentivizing complete orders.
